...
Misalnya, paket
https://pkg.go.dev/golang.org/x/text/collate[collate^],
...
Secara praktik,
https://www.macchiato.com/unicode-intl-sw/nfc-faq#h.h8uqckv6osay[99.98%^]
...
https://pkg.go.dev/golang.org/x/text/unicode/norm[unicode/norm^]
